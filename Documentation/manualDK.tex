	...
	\begin{tabular}{cc}
		...
		\begin{minipage}{0.45\textwidth}
			...
			\href{https://youtu.be/7Y-k81tILdg}{%
				\includegraphics[width=0.65\linewidth]{images/demo1.png}%
			}\\[-0.5em] 
			{\fredoka\color{primarydark}\Large Demo 1}\\[-0.2em]
		...
		\begin{minipage}{0.45\textwidth}
			...
			\href{https://youtube.com/shorts/xE0CEP3kYTg}{%
				\includegraphics[width=0.65\linewidth]{images/demo2.png}%
			}\\[-0.5em]
			{\fredoka\color{primarydark}\Large Demo 2}\\[-0.2em]
			{\small BeeSMART i brug}
		\end{minipage}
		...
		\begin{minipage}{0.45\textwidth}
			...
			\href{https://youtu.be/kUqcvOjCH5E}{%
				\includegraphics[width=0.65\linewidth]{images/demo3.png}%
			}\\[-0.5em]
			{\fredoka\color{primarydark}\Large Demo 3}\\[-0.2em]
		...
		\begin{minipage}{0.45\textwidth}
			...
			\href{https://youtu.be/ojsv-gZ6waY}{%
				\includegraphics[width=0.65\linewidth]{images/montering.png}%
			}\\[-0.5em]
			{\fredoka\color{primarydark}\Large Montering}\\[-0.2em]
